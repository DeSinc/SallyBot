...
namespace SallyBot
{
    class Program
    {
        ...
        private async Task OobaboogaReply(SocketMessage message, string inputMsgFiltered)
        {
            ...
            int maxChatHistoryStrLength = 4700; // max chat history length (you can go to like 4800 before errors with oobabooga)(subtract character prompt length if you are using one)
